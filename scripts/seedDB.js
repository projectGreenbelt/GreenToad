...
const pointsSeed = [
  ...
  },
  {
    id: 1,
    name: "Trail Head",
    image: "https://violetcrowntrail.com/wp-content/uploads/2016/01/ZilkerTrailhead2-3.jpg",
  ...
  },
  {
    id: 5,
    name: "Loop 360",
    image: "https://austinot.com/wp-content/uploads/2015/03/seismic-wall-greenbelt.jpg",
  ...
  },
  {
    id: 7,
    name: "Trail's End",
    image: "https://s3-media4.fl.yelpcdn.com/bphoto/l92vAgyYrNy-vz85ObIIlw/o.jpg",
    description: "If you’re a serious, no-frills hiker, Trails End is the entrance for you. This access point leads to plenty of secluded trails ready to be explored as well as access to two hidden Greenbelt gems: the Hill of Life, which is a half-mile downhill hike from the entrance that ends at the foot of Sculpture Falls, a concealed swimming hole, perfect for a post-hike dip.",
...
db.Points
  .remove({})
  .then(() => db.Points.collection.insertMany(pointsSeed))
  .then(data => {
